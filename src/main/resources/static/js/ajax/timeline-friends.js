            ...
            for (let i = 0; i < users.length; i++) {
                content2 += `<li>
                    <div class="nearly-pepls">
                        <figure>
                            <a href="time-line.html" onclick="getTimeLine(${idUser},${users[i].idUser})" title="">
                            <img src="${users[i].imgUrl}" alt=""></a>
                        </figure>
                        <div class="pepl-info">
                            <h4><a href="time-line.html" title="" onclick="getTimeLine(${idUser},${users[i].idUser})">${users[i].fullName}</a></h4>
